...
<form class="form-horizontal m-t" id="myForm" action="${basePath}/tb/recruit/edit" method="post" enctype="multipart/form-data">
                    ...
                    <div class="ibox-title">
                        <div class="builder-tabs builder-form-tabs">
                            <ul class="nav nav-tabs">
                                <li class="active"><a href="${basePath}/tb/recruit/edit">编辑</a></li>
                            </ul>
                        </div>
                    </div>
                                    ...
                                    <div class="ibox-content">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-3">
                                                ...
                                                <input id="goodsName" value="${recruit.title}" type="text" class="form-control" name="title" required="" placeholder="请输入标题" aria-required="true">
                                            </div>
                                        </div>
