        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal m-t" id="myForm" action="${basePath}/coupon/coupon/add" method="post" >
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <input id="price" type="text" class="form-control" name="price" required="" placeholder="请输入金额" aria-required="true">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">满减金额：</label>
                            <div class="col-sm-3">
                                <input id="minPrice" type="text" class="form-control" name="minPrice" required="" placeholder="请输入满减金额" aria-required="true">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">数量：</label>
                            <div class="col-sm-3">
                                <input id="count" type="text" class="form-control" name="count" required="" placeholder="请输入数量" aria-required="true">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <div class="radio i-checks">
                                    <label>
                                        <input type="radio" checked=checked value="1" name="type"> <i></i>满减</label>
                        ...
                        <div class="form-group">
                            <div class="col-sm-8 col-sm-offset-3">
                                ...
                                <a  class="btn btn-danger" type="button"  href="${basePath}/coupon/coupon/list"><i class="fa fa-close"></i> 返回</a>
                            </div>
                        </div>
                    </form>
                </div>
                ...
                success: function(data) { // data 保存提交后返回的数据，一般为 json 数据
                    ...
                    if(data.status == 200){
                        ...
                        layer.msg(data.message,{icon: 6,time:2000,shade: 0.1},function(index){
                            window.location.href="${basePath}/coupon/coupon/list";
                        });
                    }else{
