        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal m-t" id="myForm" action="${basePath}/coupon/coupon/edit" method="post" >
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <input id="minPrice" value="${item.minPrice}" type="text" class="form-control" name="minPrice" required="" placeholder="请输入满减金额" aria-required="true">
                            </div>
                        </div>
                        <div class="form-group">
