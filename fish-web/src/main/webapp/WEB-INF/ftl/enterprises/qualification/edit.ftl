...
<form class="form-horizontal m-t" id="myForm" action="${basePath}/enterprises/qualification/edit" method="post" enctype="multipart/form-data">
                    ...
                    <div class="ibox-title">
                        <div class="builder-tabs builder-form-tabs">
                            <ul class="nav nav-tabs">
                                <li class="active"><a href="${basePath}/enterprises/qualification/edit">编辑</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="ibox-content" style="border:none;">
                                    ...
                                    <div class="ibox-content">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-3">
                                                ...
                                                <input id="goodsName" value="${enterpriseQualification.describe}" type="text" class="form-control" name="describe" required="" placeholder="请输入描述" aria-required="true">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label">资质内容：</label>
                                            <div class="col-sm-9" >
                                            <textarea id="editor_id" name="brief" style="width:700px;height:300px;">
                                            ${enterpriseQualification.brief}
                                            </textarea>
                                            </div>
                                        </div>
                        ...
                        <div class="form-group">
                            <div class="col-sm-8 col-sm-offset-3">
                                <input type="hidden" name="id" value=" ${enterpriseQualification.id}"/>
                                <button class="btn btn-primary" type="submit">提交</button>
                                <a  class="btn btn-danger" type="button"  href="${basePath}/enterprises/qualification/list"><i class="fa fa-close"></i> 返回</a>
                            </div>
                        </div>
                ...
                success: function(data) { // data 保存提交后返回的数据，一般为 json 数据
                    ...
                    if(data.status == 200){
                        ...
                        layer.msg(data.message,{icon: 6,time:2000,shade: 0.1},function(index){
                            window.location.href="${basePath}/enterprises/qualification/list";
                        });
                    }else{
