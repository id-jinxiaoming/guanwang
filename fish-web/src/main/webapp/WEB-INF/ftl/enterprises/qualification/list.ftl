        ...
        <div class="ibox-title">
            <div class="builder-tabs builder-form-tabs">
                <ul class="nav nav-tabs">
                    <li class="active"><a href="${basePath}/enterprises/qualification/list">企业资质内容</a></li>
                </ul>
            </div>
        </div>
                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        <script id="datalist" type="text/html">
                            ...
                            <tr class="long-td">
                                ...
                                <td>{{d[i].describe}}</td>
                                <td>
								<@shiro.hasPermission name="enterprises:qualification:edit">
                                    <a href="${basePath}/enterprises/qualification/edit/{{d[i].id}}"  class="btn btn-primary  btn-xs">
...
<script type="text/javascript">
    ...
    function Ajaxpage(curr){
        ...
        $.ajax({
            url: "${basePath}/enterprises/qualification/list",
    ...
    function edit(id){
        window.location.href="${basePath}/enterprises/qualification/edit/"+id;
