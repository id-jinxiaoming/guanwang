    ...
    <div class="ibox float-e-margins">
        <div class="ibox-title">
            <div class="builder-tabs builder-form-tabs">
                <ul class="nav nav-tabs">
                    <li class="active"><a href="${basePath}/about/company/list">首页关于艺成园</a></li>
                </ul>
            </div>
        </div>
        <div class="ibox-content" style="border-color: transparent">
            ...
            <div class="example-wrap">
                <div class="example">
				<#--<@shiro.hasPermission name="about:company:add">
                    <button type="button" class="btn btn-outline btn-primary" onclick="add()">创建</button>
				</@shiro.hasPermission>
				<@shiro.hasPermission name="about:company:delete">
                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        <script id="datalist" type="text/html">
                            ...
                            <tr class="long-td">
                                ...
                                <td>
								<@shiro.hasPermission name="about:company:edit">
                                    <a href="${basePath}/about/company/edit/{{d[i].id}}"  class="btn btn-primary  btn-xs">
...
<script type="text/javascript">
    ...
    function Ajaxpage(curr){
        ...
        $.ajax({
            url: "${basePath}/about/company/list",
    ...
    function add(){
        window.location.href="${basePath}/about/company/add";

    }
    function edit(id){
        window.location.href="${basePath}/about/company/edit/"+id;
    ...
    function DelAll(){
        ...
        layer.confirm('确认删除吗?', {icon: 3, title:'提示'}, function(index){
            ...
            $.ajax({
                url: "${basePath}/about/company/delete",
                data:"id="+checkArray,
                type: "POST",
                dataType:'json',
