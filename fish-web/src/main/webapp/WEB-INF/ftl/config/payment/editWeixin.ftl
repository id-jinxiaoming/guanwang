        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal m-t" id="myForm" action="${basePath}/config/payment/editWeixin" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <input id="MchId" type="text" value="${cfg.mchId}" class="form-control" name="MchId" required="" aria-required="true">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">PaternerKey：</label>
                            <div class="col-sm-3">
                                <input id="PaternerKey" type="text" value="${cfg.paternerKey}" class="form-control" name="PaternerKey" required="" aria-required="true">
                            </div>
                        </div>
                        <div class="form-group">
