        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal m-t" id="myForm" action="${basePath}/config/shippingCarrier/add" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <input id="trackingUrl" type="text" class="form-control" name="trackingUrl" required="" aria-required="true">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <input id="serviceTel" type="text" class="form-control" name="serviceTel" required="" aria-required="true">
                            </div>
                        </div>
