        ...
        <div class="ibox-title">
            <div class="builder-tabs builder-form-tabs">
                <ul class="nav nav-tabs">
                    <li class="active"><a href="${basePath}/ad/ad/list">广告列表</a></li>
                </ul>
            </div>
        </div>
	    <div class="ibox-content" style="border-color: transparent">
	        ...
	        <#--<div class="row">
	            <div class="col-sm-12">  
	                ...
	                <form id="myForm" name="admin_list_sea" class="form-search" method="post" action="${basePath}/ad/ad/list">
				...
				<@shiro.hasPermission name="ad:ad:delete">
		            ...
		            <table class="table table-bordered table-hover">
		                ...
		                {{# for(var i=0;i<d.length;i++){  }}
							<tr class="long-td">
                                <td>
                                    <input type="checkbox" class="i-checks" value="{{d[i].adId}}">
                                </td>
		                        <td>{{d[i].adId}}</td>
                                <td>
                                    <img src="{{d[i].imageUrl}}" style="height:80px" onerror="this.src='${basePath}/static/webupload/empty_mid.png'"/>
								</td>
                                <td>
                                    {{# if(d[i].status==1){ }}
								...
								<@shiro.hasPermission name="ad:ad:edit">
                                    <a href="${basePath}/ad/ad/edit/{{d[i].adId}}"  class="btn btn-primary btn-xs">
...
<div class="spiner-example">
	...
	function add(){
	    window.location.href="${basePath}/ad/ad/add";

	}
    function edit(id){
        window.location.href="${basePath}/ad/ad/edit/"+id;
