        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal m-t" id="myForm" action="${basePath}/ad/ad/edit" method="post" enctype="multipart/form-data">



                        <div class="form-group">
                            <label class="col-sm-3 control-label">轮播图(1920px*782px)：</label>
                            <div class="input-group col-sm-4">
                                <input type="hidden" id="data_photo" value="${item.imageUrl}" name="imageUrl" >
                                <div id="fileList" class="uploader-list" style="float:right"></div>
                                <div id="imgPicker" style="margin-left: 15px;" >选择图片</div>
                                <div style="margin-top: 10px;"><img id="img_data" src="${item.imageUrl}" height="120px"  style="float:left;margin-left: 50px;margin-top: -10px;" src="${basePath}/static/webupload/empty_mid.png"/></div>
                            </div>
                        </div>
