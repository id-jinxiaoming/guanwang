        ...
        <div class="ibox-title">
            <div class="builder-tabs builder-form-tabs">
                <ul class="nav nav-tabs">
                    <li class="active"><a href="${basePath}/join/our/list">联系我们</a></li>
                </ul>
            </div>
        </div>
                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        <script id="datalist" type="text/html">
                            ...
                            <tr class="long-td">
                                ...
                                <td>{{d[i].address}}</td>
                                <td>
                                    <a href="javascript:;"  onclick="openImg('{{d[i].imageOne}}')">
                                        <img src="{{d[i].imageOne}}" style="width:80px;height:80px" onerror="this.src='${basePath}/static/webupload/empty_mid.png'"/>
                                    </a>
                                </td>
                                <td>
                                    <a href="javascript:;"  onclick="openImg('{{d[i].imageTwo}}')">
                                        <img src="{{d[i].imageTwo}}" style="width:80px;height:80px" onerror="this.src='${basePath}/static/webupload/empty_mid.png'"/>
                                    </a>
                                </td>
                                <td>
                                ...
                                <td>
								<@shiro.hasPermission name="join:our:edit">
                                    <a href="${basePath}/join/our/edit/{{d[i].id}}"  class="btn btn-primary  btn-xs">
...
<script type="text/javascript">
    ...
    function edit(id){
        window.location.href="${basePath}/join/our/edit/"+id;
