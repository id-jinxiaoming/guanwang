        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal m-t" id="myForm" action="${basePath}/system/resources/add" method="post">
                        <input type="hidden" name="pid" value="${id!}" />
                        <div class="form-group">
                            <label class="col-sm-3 control-label">权限名称：</label>
                            <div class="col-sm-4">
                                <input  name="name" class="form-control" placeholder="权限名称" type="text">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input id="url" name="url" placeholder="模块/控制器/方法" class="form-control" type="text">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input id="permission" name="permission" placeholder="模块/控制器/方法" class="form-control" type="text">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input id="sort" name="sort" placeholder="输入排序" value="0" class="form-control" type="text">
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        <div class="form-group">
