	    ...
	    <div class="ibox-content" style="border-color: transparent">
	        ...
	        <div class="row">
	            <div class="col-sm-12">  
	                ...
	                <form name="admin_list_sea" class="form-search" method="get" action="${basePath}/system/dict/list">
	                    <div class="col-sm-3">
	                        <div class="input-group">
	                            <input type="text" id="key" class="form-control" name="key" value="${key?default('')}" placeholder="输入需查询的Code" />
...
<div class="spiner-example">
	...
	function add(){
	    window.location.href="${basePath}/system/dict/add";

	}
    function edit(id){
        window.location.href="${basePath}/system/dict/edit/"+id;
	...
	function DelAll(){
        ...
        layer.confirm('确认删除吗?', {icon: 3, title:'提示'}, function(index){
            ...
            $.ajax({
                url: "${basePath}/system/dict/delete",
                data:"id="+checkArray,
                type: "POST",
                dataType:'json',
