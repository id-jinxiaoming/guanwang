        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal m-t" id="myForm" action="${basePath}/system/scheduleJob/add" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <input id="group" type="text" class="form-control" name="group" required="" aria-required="true">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <input onclick="cron()" id="cronExpression" type="text" class="form-control" name="cronExpression" required="" aria-required="true">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">类名：</label>
                            <div class="col-sm-3">
                                <input id="className" type="text" class="form-control" name="className" required="" aria-required="true">
                            </div>
                        </div>
