...
<html>
<head>
    <link href="${basePath}/static/Cron/themes/bootstrap/easyui.min.css" rel="stylesheet" type="text/css" />
    <link href="${basePath}/static/Cron/themes/icon.css" rel="stylesheet" type="text/css" />
    <link href="${basePath}/static/Cron/icon.css" rel="stylesheet" type="text/css" />
    <style type="text/css">
        .line
        {
            height: 25px;
...
<body>
    ...
    <div class="easyui-layout" style="width:830px;height:480px; border: 1px rgb(202, 196, 196) solid;
            border-radius: 5px;">
        ...
        <div data-options="region:'south',border:false" style="height:160px">
            <fieldset style="border-radius: 3px; height: 140px;">
                <legend>表达式</legend>
            ...
            <div style="text-align: center; margin-top: 5px;">
                <script type="text/javascript">
                    ...
                    function submit(){
                        ...
                        parent.$("#cronExpression").val($("#cron").val());
...
<script src="${basePath}/static/Cron/jquery-1.6.2.min.js" type="text/javascript"></script>
<script src="${basePath}/static/Cron/jquery.easyui.min.js" type="text/javascript"></script>
<script src="${basePath}/static/Cron/cron.js" type="text/javascript"></script>
</body>
</html>
