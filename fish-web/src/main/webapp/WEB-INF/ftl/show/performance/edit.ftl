...
<form class="form-horizontal m-t" id="myForm" action="${basePath}/show/performance/edit" method="post" enctype="multipart/form-data">
                    ...
                    <div class="ibox-title">
                        <div class="builder-tabs builder-form-tabs">
                            <ul class="nav nav-tabs">
                                <li class="active"><a href="${basePath}/show/performance/edit">编辑</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="ibox-content" style="border:none;">
                                    ...
                                    <div class="ibox-content">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-3">
                                                ...
                                                <input id="goodsName" value="${showPerformance.enTitle}" type="text" class="form-control" name="enTitle" required="" placeholder="请输入英文标题" aria-required="true">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-3">
                                                <input id="goodsSn" value="${showPerformance.chTitle}" type="text" class="form-control" name="chTitle" required="" placeholder="请输入标题" aria-required="true">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label">描述：</label>
                                            <div class="col-sm-3">
                                                <textarea id="instruction" name="describe" class="form-control" aria-required="true">${showPerformance.describe}</textarea>
                                            </div>
                                        </div>
                                ...
                                <div class="layui-tab-item">
                                    <div class="layui-tab-item layui-show">
                                        <div class="ibox-content">
                                            ...
                                            <div class="form-group">
                                                <label class="col-sm-3 control-label">业绩组图(966px*600px)：</label>
                                                <div class="col-sm-9" >
                        ...
                        <div class="form-group">
                            <div class="col-sm-8 col-sm-offset-3">
                                <input type="hidden" name="id" value=" ${showPerformance.id}"/>
                                <button class="btn btn-primary" type="submit">提交</button>
                                <a  class="btn btn-danger" type="button"  href="${basePath}/show/performance/list"><i class="fa fa-close"></i> 返回</a>
                            </div>
                        </div>
                ...
                success: function(data) { // data 保存提交后返回的数据，一般为 json 数据
                    ...
                    if(data.status == 200){
                        ...
                        layer.msg(data.message,{icon: 6,time:2000,shade: 0.1},function(index){
                            window.location.href="${basePath}/show/performance/list";
                        });
                    }else{
