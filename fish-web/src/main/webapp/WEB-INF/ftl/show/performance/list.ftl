        ...
        <div class="ibox-title">
            <div class="builder-tabs builder-form-tabs">
                <ul class="nav nav-tabs">
                    <li class="active"><a href="${basePath}/show/performance/list">业绩列表</a></li>
                </ul>
            </div>
        </div>
        <div class="ibox-content" style="border-color: transparent">
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <form id="myForm" name="admin_list_sea" class="form-search" method="post" action="${basePath}/show/performance/list">
            ...
            <div class="example-wrap">
                <div class="example">
				<@shiro.hasPermission name="show:performance:add">
                    <button type="button" class="btn btn-outline btn-primary" onclick="add()">创建</button>
				</@shiro.hasPermission>
				<@shiro.hasPermission name="show:performance:delete">
                        ...
                        <script id="datalist" type="text/html">
                            ...
                            <tr class="long-td">
                                ...
                                <td>
                                    ...
                                    {{#}else if(d[i].type==2){ }}
                                    <span style="background-color: #00ee00;color: #ffffff;border-radius: 5px;font-size: 20px;padding: 5px; ">展览展示</span>
                                    {{#}else if(d[i].type==3){ }}
                                    <span style="background-color: #d23a58;color: #ffffff;border-radius: 5px;font-size: 20px;padding: 5px; ">建筑幕墙</span>
                                    {{#}else if(d[i].type==4){ }}
                                ...
                                <td>
								<@shiro.hasPermission name="show:performance:edit">
                                    <a href="${basePath}/show/performance/edit/{{d[i].id}}"  class="btn btn-primary  btn-xs">
...
<script type="text/javascript">
    ...
    function Ajaxpage(curr){
        ...
        $.ajax({
            url: "${basePath}/show/performance/list",
    ...
    function add(){
        window.location.href="${basePath}/show/performance/add";

    }
    function edit(id){
        window.location.href="${basePath}/show/performance/edit/"+id;
    ...
    function DelAll(){
        ...
        layer.confirm('确认删除吗?', {icon: 3, title:'提示'}, function(index){
            ...
            $.ajax({
                url: "${basePath}/show/performance/delete",
                data:"id="+checkArray,
                type: "POST",
                dataType:'json',
