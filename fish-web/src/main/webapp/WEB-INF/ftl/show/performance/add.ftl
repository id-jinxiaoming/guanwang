...
<form class="form-horizontal m-t" id="myForm" action="${basePath}/show/performance/add" method="post" enctype="multipart/form-data">
                    ...
                    <div class="ibox-title">
                        <div class="builder-tabs builder-form-tabs">
                            <ul class="nav nav-tabs">
                                <li class="active"><a href="${basePath}/show/performance/add">创建</a></li>
                            </ul>
                        </div>
                    </div>
                                    ...
                                    <div class="ibox-content">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-3">
                                                ...
                                                <input id="goodsName" type="text" class="form-control" name="enTitle" required="" placeholder="请输入英文标题" aria-required="true">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-3">
                                                <input id="goodsSn" type="text" class="form-control" name="chTitle" required="" placeholder="请输入中文标题" aria-required="true">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-3">
                                                <textarea id="instruction" name="describe" class="form-control" required="" aria-required="true"></textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <div class="radio i-checks">
                                                    <label>
                                                        <input type="radio" checked=checked value="1" name="type"> <i></i>建筑装饰</label>
                                                    <label>
                                                        <input type="radio"  value="2" name="type"> <i></i>展览展示</label>
                                                    <label>
                                                        <input type="radio"  value="3" name="type"> <i></i>建筑幕墙</label>
                                                    <label>
                                                        <input type="radio"  value="4" name="type"> <i></i>工程设计</label>
                                                    <label>
                                                        <input type="radio"  value="5" name="type"> <i></i>其它工程</label>
                                                </div>
                                ...
                                <div class="layui-tab-item">
                                    <div class="layui-tab-item layui-show">
                                        <div class="ibox-content">
                                            ...
                                            <div class="form-group">
                                                <label class="col-sm-3 control-label">业绩组图(996px*600px)：</label>
                                                <div class="col-sm-9" >
