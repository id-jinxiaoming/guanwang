        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal m-t" id="myForm" action="${basePath}/shop/goodsOptional/add" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <input id="optText" type="text" class="form-control" name="optText" required="" placeholder="请输入名称" aria-required="true">
                            </div>
                        </div>
                        <#--<div class="form-group">-->
                            <#--<label class="col-sm-3 control-label">价格：</label>-->
                            <#--<div class="col-sm-3">-->
                                <#--<input id="optPrice" type="text" value="0" class="form-control" name="optPrice" required="" aria-required="true">-->
                            <#--</div>-->
                        <#--</div>-->
