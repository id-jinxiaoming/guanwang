        ...
        <div class="ibox-title">
            <div class="builder-tabs builder-form-tabs">
                <ul class="nav nav-tabs">
                    <li class="active"><a href="${basePath}/shop/goodsOptional/list/${goodsId}">商品选项(${goodsName})</a></li>
                </ul>
            </div>
        </div>
	    <div class="ibox-content" style="border-color: transparent">
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <form id="myForm" name="admin_list_sea" class="form-search" method="post" action="${basePath}/shop/goodsOptional/list/${goodsId}">
	        ...
	        <div class="example-wrap">
	            <div class="example">
				<@shiro.hasPermission name="shop:goodsOptional:add">
                    <button type="button" class="btn btn-outline btn-primary" onclick="add()">创建</button>
				</@shiro.hasPermission>
				<@shiro.hasPermission name="shop:goodsOptional:delete">
		            ...
		            <table class="table table-bordered table-hover">
		                ...
		                {{# for(var i=0;i<d.length;i++){  }}
							<tr class="long-td">
								...
								<@shiro.hasPermission name="shop:goodsOptional:edit">
                                    <a href="${basePath}/shop/goodsOptional/edit/${goodsId}/{{d[i].id}}"  class="btn btn-primary btn-xs">
...
<div class="spiner-example">
	...
	function Ajaxpage(curr){
		...
		$.ajax({
			url: "${basePath}/shop/goodsOptional/list",
			data:{page:curr||1,id:id,typeId:typeId},
			type: "POST",
			dataType:'json',
	...
	function add(){
	    window.location.href="${basePath}/shop/goodsOptional/add/${goodsId}";
	...
	function DelAll(){
        ...
        layer.confirm('确认删除吗?', {icon: 3, title:'提示'}, function(index){
            ...
            $.ajax({
                url: "${basePath}/shop/goodsOptional/delete",
                data:"id="+checkArray,
                type: "POST",
                dataType:'json',
