        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal m-t" id="myForm" action="${basePath}/shop/brand/edit" method="post" enctype="multipart/form-data">
                        <input type="hidden" name="brandId" value="${item.brandId}" />
                        <div class="form-group">
                            <label class="col-sm-3 control-label">品牌名称：</label>
                            <div class="col-sm-3">
                                <input id="brandName" type="text" value="${item.brandName}" class="form-control" name="brandName" required="" placeholder="请输入品牌名称" aria-required="true">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-4">
                                <input type="hidden" id="data_photo" name="brandLogo" value="${item.brandLogo}" >
                                <div id="fileList" class="uploader-list" style="float:right"></div>
                                <div id="imgPicker" style="margin-left: 15px;" >选择图片</div>
                                <div style="margin-top: 10px;"><img id="img_data" class="img-circle" height="80px" width="80px" style="float:left;margin-left: 50px;margin-top: -10px;" src="${item.brandLogo}"/></div>
                            </div>
                        </div>
                        <div class="form-group">
