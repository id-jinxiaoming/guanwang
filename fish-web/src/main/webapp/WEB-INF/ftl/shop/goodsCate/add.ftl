        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal m-t" id="myForm" action="${basePath}/shop/goodsCate/add" method="post" enctype="multipart/form-data">

                        <div class="form-group">
                            <label class="col-sm-3 control-label">父ID：</label>
                            <div class="col-sm-1">
                                <p class="form-control-static">${id}</p>
                                <input id="parentId" type="hidden" VALUE="${id}"  name="parentId" required="" >
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">名称：</label>
                            <div class="col-sm-3">
                                <input id="cateName" type="text" class="form-control" name="cateName" required="" placeholder="请输入名称" aria-required="true">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <#list Brand as p>
                                <label class="checkbox-inline">
                                    <input type="checkbox" value="${p.brandId}" name="brandIds" id="brandIds">${p.brandName}</label>
                            </#list>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <input id="seq" type="text" class="form-control" name="seq" required="" placeholder="请输入排序号" aria-required="true">
                            </div>
                        </div>
                        <div class="form-group">
