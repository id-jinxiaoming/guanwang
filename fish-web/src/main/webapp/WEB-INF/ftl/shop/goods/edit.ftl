...
<form class="form-horizontal m-t" id="myForm" action="${basePath}/shop/goods/edit" method="post" enctype="multipart/form-data">
                    ...
                    <div class="ibox-title">
                        <div class="builder-tabs builder-form-tabs">
                            <ul class="nav nav-tabs">
                                <li class="active"><a href="${basePath}/shop/goods/edit">编辑</a></li>
                            </ul>
                        </div>
                    </div>
                                    ...
                                    <div class="ibox-content">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-3">
                                                ...
                                                <input id="goodsName" value="${goodsItem.goodsName}" type="text" class="form-control" name="goodsName" required="" placeholder="请输入商品名称" aria-required="true">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-3">
                                                <select class="form-control m-b" name="cateId">
                                                    ...
                                                    <#list cate as item>
                                                        ...
                                                        <#if item.cateId==goodsItem.cateId>
                                                            selected="selected"
                                                        </#if>
                                                ...
                                                <select class="form-control m-b" name="brandId">
                                                    ...
                                                    <#list brand as item>
                                                        <option value="${item.brandId}"
                                                            <#if item.brandId==goodsItem.brandId>
                                                                selected="selected"
                                                            </#if>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-3">
                                                <input id="goodsSn" value="${goodsItem.goodsSn}" type="text" class="form-control" name="goodsSn" required="" placeholder="请输入商品货号" aria-required="true"><span class="help-block m-b-none">长度不应超过20个字符, 留空则系统会按约定规则自动生成货号</span>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label">当前售价：</label>
                                            <div class="col-sm-3">
                                                <input id="nowPrice" value="${goodsItem.nowPrice?string('0.00')}" type="text" class="form-control" name="nowPrice" required="" placeholder="请输入当前售价" aria-required="true"><span class="help-block m-b-none">售价请按此格式填写, 如: "188.00" 或 "8.00"</span>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label">原售价：</label>
                                            <div class="col-sm-3">
                                                <input id="originalPrice" value="${goodsItem.originalPrice?string('0.00')}" type="text" class="form-control" name="originalPrice" required="" placeholder="请输入原售价" aria-required="true"><span class="help-block m-b-none">留空或为0时，前台不显示原售价</span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="checkbox i-checks">
                                                    <label>
                                                        <input type="checkbox"
                                                                <#if goodsItem.newarrival=="1">
                                                                   checked=""
                                                                </#if>
                                                               name="newarrival" value="1"> <i></i> 新品</label>
                                                    <label>
                                                        <input type="checkbox"
                                                                <#if goodsItem.recommend=="1">
                                                                       checked=""
                                                                </#if>

                                                               name="recommend" value="1"> <i></i> 推荐</label>
                                                    <label>
                                                        <input type="checkbox"
                                                                <#if goodsItem.bargain=="1">
                                                                       checked=""
                                                                </#if>
                                                               name="bargain" value="1"> <i></i> 特价</label>
                                                ...
                                                <div class="radio i-checks">
                                                    <label>
                                                        <input type="radio"
                                                               ...
                                                               value="1" name="status"> <i></i>上架</label>
                                                    <label>
                                                        <input type="radio"
                                                               ...
                                                               value="0" name="status"> <i></i>下架</label>
                                                </div>
                                        ...
                                        <div class="ibox-content">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9" >
                                                    <div >
                                                        <!--用来存放item-->
                                                        <img id="imgPhoto1" src="${goodsItem.goodsImage}" width="150px" height="150px"/>
                                                        <input id="photo1"  value="${goodsItem.goodsImage}"  type="hidden" name="goodsImage" value=""/>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9" >
                                                    <div id="uploader-demo" >
                                                        <#list album as item>
                                                        <input id="photoId_${item.id}"  type="hidden" name="photo" value="${item.image}"/>
                                                        </#list>
                                                        <!--用来存放item-->

                                                        <div id="fileList" class="uploader-list">
                                                        <#list album as item>
                                                            <div  id="${item.id}" class="file-item thumbnail">
                                                            <img width="150px" height="150px" src="${item.image}" />
                                                            <div class="info" style="overflow: hidden; text-overflow: ellipsis; white-space: nowrap; width:150px;">${item.id}</div>
                                                            <div style="text-align: right;"><button class="info"  onclick=delImg('${item.id}') >删除</button></div>
                                                            </div>
                                                        </#list>
                                                        </div>
                                    ...
                                    <div class="layui-tab-item layui-show">
                                        <div class="ibox-content">
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-3">
                                                    <input id="integral"  value="${goodsItem.integral}" type="text" class="form-control" name="integral" required="" placeholder="请输入可用积分" aria-required="true"><span class="help-block m-b-none"></span>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-sm-3 control-label">返利积分：</label>
                                                <div class="col-sm-3">
                                                    <input id="rebateIntegral" value="${goodsItem.rebateIntegral}" type="text" class="form-control" name="rebateIntegral" required="" placeholder="请输入返利积分" aria-required="true"><span class="help-block m-b-none"></span>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-sm-3 control-label">库存数量：</label>
                                                <div class="col-sm-3">
                                                    <input id="stockQty" value="${goodsItem.stockQty}"  type="text" class="form-control" name="stockQty" required="" placeholder="请输入库存数量" aria-required="true"><span class="help-block m-b-none"></span>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-sm-3 control-label">重量：</label>
                                                <div class="col-sm-3">
                                                    <input id="goodsWeight" value="${goodsItem.goodsWeight}" type="text" class="form-control" name="goodsWeight" required="" placeholder="请输入重量" aria-required="true"><span class="help-block m-b-none">Kg (千克)</span>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9" >
                                                     ...
                                                     <textarea id="metaKeywords"  name="metaKeywords" class="form-control" >${goodsItem.metaKeywords}</textarea>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9" >
                                                <textarea id="metaDescription" name="metaDescription" class="form-control" > ${goodsItem.metaDescription}</textarea>
