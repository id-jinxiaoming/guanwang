        ...
        <div class="ibox-title">
            <div class="builder-tabs builder-form-tabs">
                <ul class="nav nav-tabs">
                    <li class="active"><a href="${basePath}/shop/shop/list">商家列表</a></li>
                </ul>
            </div>
        </div>
	    <div class="ibox-content" style="border-color: transparent">
	        ...
	        <div class="row">
	            <div class="col-sm-12">  
	                ...
	                <form id="myForm" name="admin_list_sea" class="form-search" method="post" action="${basePath}/shop/shop/list">
	        ...
	        <div class="example-wrap">
	            <div class="example">
				<@shiro.hasPermission name="shop:shop:add">
				...
				<@shiro.hasPermission name="shop:shop:delete">
		            ...
		            <table class="table table-bordered table-hover">
		                <thead>
                                ...
                                <th style="text-align:center;">商户帐号</th>
		                ...
		                {{# for(var i=0;i<d.length;i++){  }}
							<tr class="long-td">
                                <td>
                                    <input type="checkbox" class="i-checks" value="{{d[i].shopId}}">
                                </td>
                                <td>{{d[i].shopId}}</td>
                                <td>
                                    <img src="{{d[i].imgUrl}}" style="height:80px" onerror="this.src='${basePath}/static/webupload/empty_mid.png'"/>
                                </td>
		                        <td>{{d[i].title}}</td>
                                <td>{{d[i].username}}</td>
							  	<td>{{d[i].subTitle}}</td>
								...
								<@shiro.hasPermission name="shop:shop:edit">
                                    <a href="${basePath}/shop/shop/edit/{{d[i].shopId}}"  class="btn btn-primary btn-xs">
                                        <i class="fa fa-paste"></i> 编辑</a>
                                </@shiro.hasPermission>
                                <@shiro.hasPermission name="shop:shopCoupon:list">
                                    <a href="${basePath}/shop/shopCoupon/list/{{d[i].shopId}}"  class="btn btn-primary btn-xs">
                                        <i class="fa fa-paste"></i> 代金券管理</a>
                                </@shiro.hasPermission>
...
<div class="spiner-example">
	...
	function add(){
	    window.location.href="${basePath}/shop/shop/add";

	}
    function edit(id){
        window.location.href="${basePath}/shop/shop/edit/"+id;
