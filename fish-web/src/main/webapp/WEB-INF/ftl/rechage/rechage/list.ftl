        ...
        <div class="ibox-title">
            <div class="builder-tabs builder-form-tabs">
                <ul class="nav nav-tabs">
                    <li class="active"><a href="${basePath}/rechage/rechage/list">充值套餐</a></li>
                </ul>
            </div>
        </div>
	    <div class="ibox-content" style="border-color: transparent">
	        ...
	        <div class="row">
	            <div class="col-sm-12">  
	                ...
	                <form id="myForm" name="admin_list_sea" class="form-search" method="post" action="${basePath}/rechage/rechage/list">
	        ...
	        <div class="example-wrap">
	            <div class="example">
				<@shiro.hasPermission name="rechage:rechage:add">
                    <button type="button" class="btn btn-outline btn-primary" onclick="add()">创建</button>
				</@shiro.hasPermission>
				<@shiro.hasPermission name="rechage:rechage:delete">
		            ...
		            <table class="table table-bordered table-hover">
		                <thead>
                                ...
                                <th style="text-align:center;">返券(元)</th>
		                ...
		                {{# for(var i=0;i<d.length;i++){  }}
							<tr class="long-td">
                                <td>
                                    <input type="checkbox" class="i-checks" value="{{d[i].rechageId}}">
                                </td>
		                        <td>{{d[i].rechageId}}</td>
							  	<td>{{d[i].title}}</td>
								...
								<@shiro.hasPermission name="rechage:rechage:edit">
                                    <a href="${basePath}/rechage/rechage/edit/{{d[i].rechageId}}"  class="btn btn-primary btn-xs">
...
<div class="spiner-example">
	...
	function Ajaxpage(curr){
		...
		$.ajax({
			url: "${basePath}/rechage/rechage/list",
	...
	function add(){
	    window.location.href="${basePath}/rechage/rechage/add";

	}
    function edit(id){
        window.location.href="${basePath}/rechage/rechage/edit/"+id;
	...
	function DelAll(){
        ...
        layer.confirm('确认删除吗?', {icon: 3, title:'提示'}, function(index){
            ...
            $.ajax({
                url: "${basePath}/rechage/rechage/delete",
                data:"id="+checkArray,
                type: "POST",
                dataType:'json',
