        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal m-t" id="myForm" action="${basePath}/rechage/rechage/add" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <input id="money" type="text" value="0" class="form-control" name="money" required="" aria-required="true">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label">返券：</label>
                                <div class="col-sm-3">
                                    <input id="coupon" type="text" value="0" class="form-control" name="coupon" required="" aria-required="true">
                                </div>
                            </div>
