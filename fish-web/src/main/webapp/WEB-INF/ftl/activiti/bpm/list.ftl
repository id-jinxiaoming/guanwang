	...
	<div class="ibox float-e-margins">
	    ...
	    <div class="ibox-content" style="border-color: transparent">
	        ...
	        <div class="example-wrap">
	            <div class="example">
					<@shiro.hasPermission name="activiti:leave:add">
						<button type="button" class="btn btn-outline btn-primary" onclick="add()">启动</button>
					</@shiro.hasPermission>
		            ...
		            <table class="table table-bordered table-hover">
		                ...
		                {{# for(var i=0;i<d.length;i++){  }}
							<tr class="long-td">
                                ...
                                <td>
								<@shiro.hasPermission name="activiti:bpm:edit">
                                    <button type="button" class="btn btn-primary  btn-sm" onclick="edit('{{d[i].id}}')">办理</button>
								</@shiro.hasPermission>

								<@shiro.hasPermission name="activiti:bpm:show">
...
<div class="spiner-example">
	...
	function Ajaxpage(curr){
		$.ajax({
			url: "${basePath}/activiti/bpm/list",
			data:{page:curr||1},
			type: "POST",
			dataType:'json',
	...
	//启动
	function add(){
	    window.location.href="${basePath}/activiti/leave/add";

	}
    //办理
    function edit(id){

        window.location.href="${basePath}/activiti/bpm/edit?id="+id;
    ...
    function show(id){
        layer.open({
            ...
            closeBtn: 1,
            shadeClose: true,
            content: '${basePath}/activiti//bpm/show?taskId='+id
        });
