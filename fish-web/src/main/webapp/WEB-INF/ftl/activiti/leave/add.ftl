        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal m-t" id="myForm" action="${basePath}/activiti/leave/add" method="post" enctype="multipart/form-data">


                        <div class="form-group">
                            <label class="col-sm-3 control-label">天数：</label>
                            <div class="col-sm-3">
                                <input id="days" type="text" class="form-control" name="days" required="" aria-required="true">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">事由：</label>
                            <div class="col-sm-3">
                                <input id="reason" type="text" class="form-control" name="reason" required="" aria-required="true">
                            </div>
                        </div>
