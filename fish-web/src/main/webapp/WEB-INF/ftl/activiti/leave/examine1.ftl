        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal m-t" id="myForm" action="${basePath}/activiti/leave/examine1" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <div class="radio i-checks">
                                    <label><input type="radio" value="同意" name="status" checked> <i></i> 同意</label>
                                    <label><input type="radio" value="不同意" name="status" > <i></i> 不同意</label>
                                </div>
                            </div>
                        </div>
