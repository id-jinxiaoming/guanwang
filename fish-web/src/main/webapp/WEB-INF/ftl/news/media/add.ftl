...
<form class="form-horizontal m-t" id="myForm" action="${basePath}/news/media/add" method="post" enctype="multipart/form-data">
                    ...
                    <div class="ibox-title">
                        <div class="builder-tabs builder-form-tabs">
                            <ul class="nav nav-tabs">
                                <li class="active"><a href="${basePath}/news/media/add">创建</a></li>
                            </ul>
                        </div>
                    </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <div class="radio i-checks">
                                                    <label>
                                                        <input type="radio" checked=checked value="1" name="type"> <i></i>行业资讯</label>
                                                    <label>
                                                        <input type="radio"  value="2" name="type"> <i></i>公司新闻</label>
                                                </div>
                                            </div>
                                        </div>
