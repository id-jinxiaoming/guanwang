...
<form class="form-horizontal m-t" id="myForm" action="${basePath}/enterprise/performance/edit" method="post" enctype="multipart/form-data">
                    ...
                    <div class="ibox-title">
                        <div class="builder-tabs builder-form-tabs">
                            <ul class="nav nav-tabs">
                                <li class="active"><a href="${basePath}/enterprise/performance/edit">编辑</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="ibox-content" style="border:none;">
                                    ...
                                    <div class="ibox-content">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-3">
                                                ...
                                                <input id="goodsName" value="${enterprisePerformance.english}" type="text" class="form-control" name="english" required="" placeholder="请输入英文名称" aria-required="true">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-3">
                                                <input id="goodsSn" value="${enterprisePerformance.chinese}" type="text" class="form-control" name="chinese" required="" placeholder="请输入中文名称" aria-required="true">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <div class="radio i-checks">
                                                    <label>
                                                        <input type="radio"
                                                                <#if enterprisePerformance.position=="1">
                                                                       checked=""
                                                                </#if>

                                                               value="1" name="position"> <i></i>建筑装饰</label>
                                                    <label>
                                                        <input type="radio"
                                                                <#if enterprisePerformance.position=="2">
                                                                       checked=""
                                                                </#if>

                                                               value="2" name="position"> <i></i>建筑幕墙</label>
                                                    <label>
                                                        <input type="radio"
                                                                <#if enterprisePerformance.position=="3">
                                                                       checked=""
                                                                </#if>

                                                               value="3" name="position"> <i></i>展览展示</label>
                                                    <label>
                                                        <input type="radio"
                                                                <#if enterprisePerformance.position=="4">
                                                                       checked=""
                                                                </#if>

                                                               value="4" name="position"> <i></i>工程设计</label>
                                                    <label>
                                                        <input type="radio"
                                                                <#if enterprisePerformance.position=="5">
                                                                       checked=""
                                                                </#if>

                                                               value="5" name="position"> <i></i>其它工程</label>
                                                </div>
                                        ...
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label">分类图片(768px*600px)：</label>
                                            <div class="col-sm-9" >
                                                <div >
                                                    <!--用来存放item-->
                                                    <img id="imgPhoto1" src="${enterprisePerformance.image}" width="150px" height="150px"/>
                                                    <input id="photo1"  value="${enterprisePerformance.image}"  type="hidden" name="image" value=""/>
                        ...
                        <div class="form-group">
                            <div class="col-sm-8 col-sm-offset-3">
                                <input type="hidden" name="id" value=" ${enterprisePerformance.id}"/>
                                <button class="btn btn-primary" type="submit">提交</button>
                                <a  class="btn btn-danger" type="button"  href="${basePath}/enterprise/performance/list"><i class="fa fa-close"></i> 返回</a>
                            </div>
                        </div>
                ...
                success: function(data) { // data 保存提交后返回的数据，一般为 json 数据
                    ...
                    if(data.status == 200){
                        ...
                        layer.msg(data.message,{icon: 6,time:2000,shade: 0.1},function(index){
                            window.location.href="${basePath}/enterprise/performance/list";
                        });
                    }else{
