...
<form class="form-horizontal m-t" id="myForm" action="${basePath}/enterprise/performance/add" method="post" enctype="multipart/form-data">
                    ...
                    <div class="ibox-title">
                        <div class="builder-tabs builder-form-tabs">
                            <ul class="nav nav-tabs">
                                <li class="active"><a href="${basePath}/enterprise/performance/add">创建</a></li>
                            </ul>
                        </div>
                    </div>
                                    ...
                                    <div class="ibox-content">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-3">
                                                ...
                                                <input id="goodsName" type="text" class="form-control" name="english" required="" placeholder="请输入英文名称" aria-required="true">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-3">
                                                <input id="goodsSn" type="text" class="form-control" name="chinese" required="" placeholder="请输入中文名称" aria-required="true">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <div class="radio i-checks">
                                                    <label>
                                                        <input type="radio" checked=checked value="1" name="position"> <i></i>建筑装饰</label>
                                                    <label>
                                                        <input type="radio"  value="2" name="position"> <i></i>建筑幕墙</label>
                                                    <label>
                                                        <input type="radio"  value="3" name="position"> <i></i>展览展示</label>
                                                    <label>
                                                        <input type="radio"  value="4" name="position"> <i></i>工程设计</label>
                                                    <label>
                                                        <input type="radio"  value="5" name="position"> <i></i>其它工程</label>
                                                </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9" >
                                                <div >
                                                    ...
                                                    <input id="photo1"  type="hidden" name="image" value=""/>
