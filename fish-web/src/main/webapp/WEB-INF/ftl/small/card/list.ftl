        ...
        <div class="ibox-title">
            <div class="builder-tabs builder-form-tabs">
                <ul class="nav nav-tabs">
                    <li class="active"><a href="${basePath}/small/card/list">卡片内容显示</a></li>
                </ul>
            </div>
        </div>
        <div class="ibox-content" style="border-color: transparent">
            ...
            <#--<div class="row">
                <div class="col-sm-12">
                   ...
                   &lt;#&ndash; <form id="myForm" name="admin_list_sea" class="form-search" method="post" action="${basePath}/shop/goods/list">
            ...
            <div class="example-wrap">
                <div class="example">
				<@shiro.hasPermission name="small:card:add">
                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        <script id="datalist" type="text/html">
                            ...
                            <tr class="long-td">
                                ...
                                <td>{{d[i].bigTitle}}</td>
                                <td>{{d[i].smallTitle}}</td>
                                <td>
								<@shiro.hasPermission name="small:card:edit">
                                    <a href="${basePath}/small/card/edit/{{d[i].id}}"  class="btn btn-primary  btn-xs">
...
<script type="text/javascript">
    ...
    function add(){
        window.location.href="${basePath}/small/card/add";

    }
    function edit(id){
        window.location.href="${basePath}/small/card/edit/"+id;
    ...
    function DelAll(){
        ...
        layer.confirm('确认删除吗?', {icon: 3, title:'提示'}, function(index){
            ...
            $.ajax({
                url: "${basePath}/small/card/delete",
                data:"id="+checkArray,
                type: "POST",
                dataType:'json',
