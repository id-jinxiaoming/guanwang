...
<form class="form-horizontal m-t" id="myForm" action="${basePath}/small/card/add" method="post" enctype="multipart/form-data">
                    ...
                    <div class="ibox-title">
                        <div class="builder-tabs builder-form-tabs">
                            <ul class="nav nav-tabs">
                                <li class="active"><a href="${basePath}/small/card/add">创建</a></li>
                            </ul>
                        </div>
                    </div>
                                    ...
                                    <div class="ibox-content">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-3">
                                                ...
                                                <input id="goodsName" type="text" class="form-control" name="bigSmall" required="" placeholder="请输入标题内容" aria-required="true">
                                            </div>
                                        </div>

                                        <div class="form-group">
                                            <label class="col-sm-3 control-label">内容(小标题)：</label>
                                            <div class="col-sm-9" >
                ...
                success: function(data) { // data 保存提交后返回的数据，一般为 json 数据
                    ...
                    if(data.status == 200){
                        ...
                        layer.msg(data.message,{icon: 6,time:2000,shade: 0.1},function(index){
                            window.location.href="${basePath}/card/small/list";
                        });
                    }else{
