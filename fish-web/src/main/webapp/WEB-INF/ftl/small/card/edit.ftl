...
<form class="form-horizontal m-t" id="myForm" action="${basePath}/small/card/edit" method="post" enctype="multipart/form-data">
                    ...
                    <div class="ibox-title">
                        <div class="builder-tabs builder-form-tabs">
                            <ul class="nav nav-tabs">
                                <li class="active"><a href="${basePath}/small/card/edit">编辑</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="ibox-content" style="border:none;">
                                    ...
                                    <div class="ibox-content">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-3">
                                                ...
                                                <input id="goodsName" value="${smallCard.bigTitle}" type="text" class="form-control" name="bigTitle" required="" placeholder="请输入标题内容" aria-required="true">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label">小标题：</label>
                                            <div class="col-sm-9" >
                                            <textarea id="editor_id" name="smallTitle" style="width:700px;height:300px;">
                                            ${smallCard.smallTitle}
                                            </textarea>
                                            </div>
                                        </div>
                        ...
                        <div class="form-group">
                            <div class="col-sm-8 col-sm-offset-3">
                                <input type="hidden" name="id" value=" ${smallCard.id}"/>
                                <button class="btn btn-primary" type="submit">提交</button>
                                <a  class="btn btn-danger" type="button"  href="${basePath}/small/card/list"><i class="fa fa-close"></i> 返回</a>
                            </div>
                        </div>
...
<script >
    ...
    $().ready(function() {
        ...
        var editor = KindEditor.create('textarea[name="smallTitle"]', {
                ...
                success: function(data) { // data 保存提交后返回的数据，一般为 json 数据
                    ...
                    if(data.status == 200){
                        ...
                        layer.msg(data.message,{icon: 6,time:2000,shade: 0.1},function(index){
                            window.location.href="${basePath}/small/card/list";
                        });
                    }else{
